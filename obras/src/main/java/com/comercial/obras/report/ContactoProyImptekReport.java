...
public class ContactoProyImptekReport {

	private final Collection<ContactoProyecto> list;

	public ContactoProyImptekReport(Collection<ContactoProyecto> c) {
	...
	private DynamicReport getReport(Style headerStyle, Style detailTextStyle, Style detailNumStyle)
		...
		AbstractColumn columnProyObrEx = createColumn("contactoProyectoObr", String.class, "PROYECTO", 25, headerStyle, detailTextStyle);
		AbstractColumn columnContCiuObr = createColumn("contactoCiudadObr", String.class, "CIUDAD", 15, headerStyle, detailTextStyle);
		AbstractColumn columnContZonObr = createColumn("contactoZonaObr", String.class, "ZONA", 15, headerStyle, detailNumStyle);
		AbstractColumn columnContAvanObr = createColumn("contactoAvanceObr", String.class, "AVANCE", 15, headerStyle, detailNumStyle);
		AbstractColumn columnNombreContEx = createColumn("nombreContact", String.class, "CONTACTO", 20, headerStyle, detailNumStyle);
		AbstractColumn columnTelfContEx = createColumn("telefonoContact", String.class, "TELEFONO", 20, headerStyle, detailNumStyle);
		AbstractColumn columnCorreoContEx = createColumn("correoContact", String.class, "CORREO", 20, headerStyle, detailNumStyle);
		...
		report.setTitle("Contactos Obras Imptek Report");
		report.setTitleStyle(titleStyle.build());
		report.setSubtitle("Listado Contactos Obras Imptek"+"\\n"+"Fecha de creación: "+dateString+"\\n");
